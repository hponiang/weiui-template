<template>
    <div class="app">
        ...
        <weiui_list v-if="active==='ionicons'" class="lists" :weiui="{ pullTips: false }">
            <div v-for="list in ionicons" class="list">
        ...
        <weiui_list v-else-if="active==='taobao'" class="lists" :weiui="{ pullTips: false }">
