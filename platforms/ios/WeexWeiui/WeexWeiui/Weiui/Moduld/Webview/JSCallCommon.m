...
- (void) setJSCallAll:(id)webBridge webView:(WKWebView*)webView
{
    ...
    [self setJSCallAssign:webView name:@"weiui_citypicker" bridge:[[WeiuiCitypickerBridge alloc] init]];
    [self setJSCallAssign:webView name:@"weiui_pay" bridge:[[WeiuiPayBridge alloc] init]];
    [self setJSCallAssign:webView name:@"weiui_picture" bridge:[[WeiuiPictureBridge alloc] init]];
