...
import com.luck.picture.lib.weiui.ui.module.WebModule;
import com.luck.picture.lib.weiui.ui.module.WeexModule;
...
public class weiui_picture {
    ...
    public static void init() {
        try {
            WXSDKEngine.registerModule("weiui_picture", WeexModule.class);
            ModuleDelegate.register("weiui_picture", new WebModule());
        } catch (WXException e) {
            e.printStackTrace();
        }
    }
